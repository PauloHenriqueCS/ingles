...
const PT_BR: TutorialUiStrings = {
  ...
  step6: {
    ...
    body: 'Use o menu para acompanhar seu plano, histórico, calendário e evolução.',
    plan: { label: 'Plano de ensino', desc: 'veja o que está aprendendo e o que vem depois.' },
    calendar: { label: 'Calendário', desc: 'acompanhe os dias e atividades realizadas.' },
    history: { label: 'Histórico', desc: 'reveja suas práticas.' },
    evolution: { label: 'Evolução', desc: 'acompanhe seu desenvolvimento.' },
    reminder: { label: 'Lembrete de prática', desc: 'escolha quando o Orodim deve lembrar você de estudar.' },
  },
  step7: {
    title: 'Tudo pronto',
...
const EN: TutorialUiStrings = {
  ...
  step6: {
    ...
    body: 'Use the menu to follow your plan, history, calendar and progress.',
    plan: { label: 'Teaching plan', desc: "see what you're learning and what comes next." },
    calendar: { label: 'Calendar', desc: 'track your days and completed activities.' },
    history: { label: 'History', desc: 'revisit your practices.' },
    evolution: { label: 'Progress', desc: 'follow your development.' },
    reminder: { label: 'Practice reminder', desc: 'choose when Orodim should remind you to study.' },
  },
  step7: {
