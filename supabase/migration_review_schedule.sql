-- AGENDAMENTO DE REVISAO (Spaced Repetition step 5 — final)
-- Execute no Supabase SQL Editor

-- =====================================================================
-- 1. Permitir next_review_at = NULL para grupos dominados (mastered)
-- =====================================================================
...
create table if not exists public.review_schedule_history (
  ...
  -- garante idempotência: uma entrada de histórico por tentativa
...
-- =====================================================================
-- 3. RPC apply_review_schedule
--    Atualiza o agendamento de forma atômica e idempotente.
--    Segurança: SECURITY INVOKER (RLS se aplica, auth.uid() ativo).
-- =====================================================================
